$(document).ready(function() {
    ...
    $("#maske1").on("mouseover", function() {
        ...
        $("#logo").css({ "transform": "scale(1.15)", "transition": "all 0.5s ease" });
    ...
    $("#maske1").on("mouseleave", function() {
        ...
        $("#logo").css({ "transform": "scale(1)", "transition": "all 0.5s ease" });
    ...
    $("#maske2").on("mouseover", function() {
        ...
        $("#line2").show(300);
        $(this).css({ 'cursor': 'pointer' });
        $("#liste-ul>li:nth-child(2)>a").css({ 'color': 'aqua' });
    ...
    $("#maske3").on("mouseover", function() {
        ...
        $("#liste-ul>li:nth-child(3)>a").css({ 'color': 'aqua' });
    ...
    $("#maske4").on("mouseover", function() {
        ...
        $("#liste-ul>li:nth-child(4)>a").css({ 'color': 'aqua' });
    ...
    $("#maske5").on("mouseover", function() {
        ...
        $("#liste-ul>li:nth-child(5)>a").css({ 'color': 'aqua' });
    ...
    $("#maske6").on("mouseover", function() {
        ...
        $("#liste-ul>li:nth-child(6)>a").css({ 'color': 'aqua' });
